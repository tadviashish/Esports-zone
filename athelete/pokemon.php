...
if (isset($_SESSION["user"]) && $_SESSION["pass"]) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "INSERT INTO pokemon(atheleteid, gameid, ingamename, role, avgscore, wrate, noofbattle, activetime, previousexp) VALUES ('$atheleteid','$playerid','$playername','$role','$score','$winrate','$battle','$activetime','$bio')";
        $result = mysqli_query($conn, $sql);
        if ($result) {
            echo "Data entered";
...
<body>
    ...
    <div class="container">
        <aside class="sidebar">
            <div class="profile">
                <img src="../img/Scout.jpg" alt="Profile Image">
        ...
        <div class="profile2">
            <div class="games">
                ...
                <a href="pokemon.php"><button class="bt1">Pokemon Unite</button></a>
            </div>
            <div class="form-container">
                ...
                <form action="pokemon.php" method="post">
                    ...
                    <label for="avgs">Average Score</label>
                    <input type="text" id="avgs" name="score" placeholder="Average Score">

                    <label for="wrate">Win Rate</label>
                    <input type="number" id="wrate" name="win" placeholder="Enter Win Rate">

                    <label for="battles">Number of Battles</label>
                    <input type="text" id="battles" name="battle" placeholder="No. of Battles">

                    <label for="active">Active Time</label>
                    <input type="text" id="active" name="activetime" placeholder="Your Active Time in Game">
